...
function scene:create( event )
  ...
  target = display.newImage( "targetCover.png", display.contentCenterX, display.contentCenterY + 40 )
  target:scale( 0.3, 0.3 )

  line1 = display.newRect( 0, display.contentCenterY + 124,display.contentWidth*2, 1)
  ...
  line2 = display.newRect( 0, display.contentCenterY-60+124,display.contentWidth*2, 1)
  ...
  line3 = display.newRect( 0, 269,display.contentWidth*2, 1)
  ...
  local function onLocalCollision( self, event )
    if ( event.phase == "began" ) then
        ...
        if alerts == 1 then
					composer.showOverlay("overlay", { isModal = true, effect = "fade", time = 400, params = { win = "false", level = 5}})
					attempts = 0
					attempt:setLabel("Attempt " .. attempts)
        end
    elseif ( event.phase == "ended" ) then
  ...
  local function onLocalCollisionline2( self, event )
    ...
    if collide1 == 1 then
      ...
      if count ==  2 then
        composer.showOverlay("overlay", { isModal = true, effect = "fade", time = 400, params = { win = "true", level = 5 }})
        collide1 = 0
       collide2 = 0
        collide3 = 0
				attempts = 0

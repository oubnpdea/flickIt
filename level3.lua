...
function scene:create( event )
  ...
  target = display.newImage( "targetCover.png", display.contentCenterX, display.contentCenterY - 20 )
  target:scale( 0.3, 0.38 )

  --[[line1 = display.newRect( 0, display.contentCenterY+80,display.contentWidth*2, 1)
  ...
  line2 = display.newRect( 0, display.contentCenterY-60+80,display.contentWidth*2, 1)
  ...
  line3 = display.newRect( 0, 184,display.contentWidth*2, 1)
  ...
  local function update( event )
    ...
    if (y-r < top) then
      composer.showOverlay("overlay", { isModal = true, effect = "fade", time = 400, params = { win = "false", level = 3 }})
      attempts = 0
      attempt:setLabel("Attempt " .. attempts)
    ...
    if (direction == "down" and y+r <= bot) then
      composer.showOverlay("overlay", { isModal = true, effect = "fade", time = 400, params = { win = "true", level = 3 }})
      attempts = 0
      attempt:setLabel("Attempt " .. attempts)
      count = 0
      timer.cancel( event.source )
